...
public class AuthLimboSessionHandler implements LimboSessionHandler {
    ...
    public AuthLimboSessionHandler(SimpleLoginVelocity plugin, AuthLimboManager limboManager, VelocityAuthManager authManager) {
        this.plugin = plugin;
    ...
    public void onSpawn(Limbo server, LimboPlayer limboPlayer) {
        ...
        plugin.getLogger().debug("[Limbo] {} spawned in native limbo.", player.getUsername());
    ...
    public void onDisconnect() {
        if (limboPlayer != null) {
            ...
            plugin.getLogger().debug("[Limbo] {} disconnected from native limbo.", player.getUsername());
        }
    }
