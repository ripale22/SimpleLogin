package com.premiumauth.simplelogin.services;
...
import com.premiumauth.simplelogin.utils.RateLimiter;
...
public class MojangApiService {
    ...
    public MojangApiService(SimpleLoginPlugin plugin, AuthCache authCache) {
        this.plugin = plugin;
    ...
    public CompletableFuture<Optional<MojangProfile>> fetchPremiumProfile(String username) {
        ...
        return supplyAsync(() -> {
            ...
            Request request = new Request.Builder()
                    .url(url)
                    .header("User-Agent", "simplelogin/1.0")
                    .get()
                    .build();
