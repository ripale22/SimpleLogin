package com.premiumauth.simplelogin.velocity.services;
...
public class VelocityMojangService {
    ...
    public VelocityMojangService(SimpleLoginVelocity plugin) {
        this.plugin = plugin;
    ...
    public CompletableFuture<Optional<MojangProfile>> fetchProfile(String username) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            Request request = new Request.Builder()
                    .url(url)
                    .header("User-Agent", "simplelogin-Velocity/1.0")
                    .get()
                    .build();
