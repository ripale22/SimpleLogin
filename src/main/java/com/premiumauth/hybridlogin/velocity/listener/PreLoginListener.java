...
public class PreLoginListener {
    ...
    public PreLoginListener(HybridLoginVelocity plugin, VelocityMojangService mojangService) {
        this.plugin = plugin;
    ...
    public EventTask onPreLogin(PreLoginEvent event) {
        return EventTask.async(() -> {
            ...
            try {
                ...
                plugin.getLogger().error("[HybridLogin] Error detectando estado de '{}'. Conexión rechazada por seguridad.", username, e);
                event.setResult(PreLoginEvent.PreLoginComponentResult.denied(
