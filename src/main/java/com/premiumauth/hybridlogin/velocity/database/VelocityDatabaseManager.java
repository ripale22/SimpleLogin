package com.premiumauth.hybridlogin.velocity.database;
...
public class VelocityDatabaseManager {
    ...
    public VelocityDatabaseManager(HybridLoginVelocity plugin, VelocityConfigManager configManager) {
        this.plugin = plugin;
    ...
    private void initializePool() {
        ...
        config.setPoolName("HybridLoginVelocityPool");
