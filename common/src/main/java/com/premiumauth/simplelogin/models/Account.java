...
/**
 * Unified data model representing a user account in the database.
 */
public class Account {
    ...
    public Account(int id, String username, UUID premiumUuid, UUID offlineUuid,
                   ...
                   String lastIp, String registeredIp, String sessionToken, long sessionExpiresAt) {
        this.id = id;
    ...
    public void setRegisteredIp(String registeredIp) { this.registeredIp = IpUtil.normalize(registeredIp); }
