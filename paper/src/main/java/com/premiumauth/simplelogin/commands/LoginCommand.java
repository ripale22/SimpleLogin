    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        plugin.getDatabaseManager().getAccount(player.getName()).thenAccept(optAccount -> {
            plugin.getServer().getScheduler().runTask(plugin, () -> {
                ...
                com.premiumauth.simplelogin.utils.PasswordHasher.VerificationResult vResult = com.premiumauth.simplelogin.utils.PasswordHasher.verify(password, acc.getPasswordHash());
                if (vResult == com.premiumauth.simplelogin.utils.PasswordHasher.VerificationResult.SUCCESS_UP_TO_DATE || vResult == com.premiumauth.simplelogin.utils.PasswordHasher.VerificationResult.SUCCESS_NEEDS_REHASH) {
                    ...
                    if (vResult == com.premiumauth.simplelogin.utils.PasswordHasher.VerificationResult.SUCCESS_NEEDS_REHASH) {
                        ...
                        plugin.getDatabaseManager().updatePassword(player.getName(), newHash);
