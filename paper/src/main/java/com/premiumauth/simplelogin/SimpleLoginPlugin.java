...
public class SimpleLoginPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        try {
            ...
            com.premiumauth.simplelogin.database.DatabaseLogger dbLogger = new com.premiumauth.simplelogin.database.DatabaseLogger() {
                @Override public void info(String msg) { getLogger().info(msg); }
                @Override public void warning(String msg) { getLogger().warning(msg); }
                @Override public void severe(String msg, Throwable t) { getLogger().log(Level.SEVERE, msg, t); }
            };
            java.util.concurrent.Executor dbExecutor = command -> getServer().getScheduler().runTaskAsynchronously(SimpleLoginPlugin.this, command);
            this.databaseManager = new DatabaseManager(this.configManager, dbLogger, getDataFolder(), dbExecutor);
